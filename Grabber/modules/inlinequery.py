    ...
    async with lock:
                    ...
                    if user:
                        ...
                        if search_terms:
                            if search_terms[0].isdigit():
                                ...
                                all_characters = [
                                    character for character in all_characters
                                    if regex.search(character['name'])
                                    or regex.search(character['anime'])
                                    or regex.search(str(character['id']))
                                ]
                    else:
                        all_characters = []
                else:
        ...
        for character in characters:
            ...
            if not img_url or not is_valid_image(img_url):
                img_url = "https://example.com/default-image.png"  # Fallback image URL
